...
//     <>
//     <div className="border border-black w-full display">
//       <Card catagory={"mens"} data={products.meesho.menData}/>
//       <Card catagory={"Women"} data={products.meesho.girlsData}/>
//       <Card catagory={"kids"} data={products.meesho.kidsData}/>
//       <Card catagory={"watch"} data={products.meesho.watchData}/>
//       <Card catagory={"shoes"} data={products.meesho.shoesData}/>
//     </div>
...
//   }
// ]
//       let [data, setData]= useState(FakeStoreAPI)

//       let filterdBoys = FakeStoreAPI.filter((f)=>f.category=="men's clothing")
//       let filterdWo = FakeStoreAPI.filter((f)=>f.category=="women's clothing")
//       let electronics = FakeStoreAPI.filter((f)=>f.category=="electronics")
//       let jewelery = FakeStoreAPI.filter((f)=>f.category=="jewelery")

//       console.log(filterdBoys)

//   return(<>
//     <button className="p-3 border rounded ml-1" onClick={()=>{setData(FakeStoreAPI)}}>Show All data</button>
//     <button className="p-3 border rounded ml-1" onClick={()=>{setData(filterdBoys)}}>Show boys data</button>
//     <button className="p-3 border rounded ml-1" onClick={()=>{setData(filterdWo)}}>Show woman data</button>
//     <button className="p-3 border rounded ml-1" onClick={()=>{setData(electronics)}}>Show electronics data</button>
//     <button className="p-3 border rounded ml-1" onClick={()=>{setData(jewelery)}}>Show jewelery data</button>
//     <button className="p-3 border rounded ml-1" onClick={()=>{setData([])}}>Clear All data</button>
//     <Child data={data} />
//   </>)
// }
// export default App
